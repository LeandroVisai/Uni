...
En el modelo M1, que solo considera el precio, todos los coeficientes son significativos y con signos coherentes. El precio (–4.321) indica que un aumento reduce la probabilidad de elección, y Heinz y Hunts muestran una preferencia base mayor que Del Monte.

El modelo M2 permite que la sensibilidad al precio varíe entre marcas. Los coeficientes siguen siendo negativos y significativos, siendo el store brand el más sensible (–6.707), mientras que Heinz y Hunts presentan menor elasticidad-precio, reflejando diferencias de reputación.

El modelo M3 incorpora heavypur, mostrando que compradores frecuentes prefieren Heinz (0.394**) y Store Brand (0.485**). A diferencia de MCO, que minimiza errores al cuadrado, la máxima verosimilitud estima parámetros que hacen más probable observar las elecciones, ideal para variables discretas como en logit.