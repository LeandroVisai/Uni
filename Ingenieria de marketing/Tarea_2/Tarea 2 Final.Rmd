...
# --- 0. Cargar Librerías (EN ORDEN CORRECTO) ---
# Paquetes base
library(readxl)
library(dplyr)      # Cargar ANTES que mlogit/gmnl
library(purrr)
library(tidyr)
library(ggplot2)
library(janitor)
...
# Paquetes de modelación (ESTE ORDEN ES CRUCIAL)
library(dfidx)     # Ayudante de mlogit
library(mlogit)    # Para P2 (debe ir ANTES de gmnl)
library(Formula)   # Cargar explícitamente

library(gmnl)      # Para P3 (debe ir DESPUÉS de mlogit)
