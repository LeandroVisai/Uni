...
```{r Unimos la base de subcategoria con los datos micro}

# Unir bases con micro para pregunta 2.
...
#Ya tenemos cargada la base de macros
...
#LA DIFERENCIA CON EL TRBAJO REALIZADO CON P0, ES QUE TOMAMOS SOLO POR AÑO.
