...
```{r Group by producto menos de 15 dolares}

datos_filtrados <- datos_precios_tc %>%
  filter(PrecioU_oferta_usd < 15)
...
ggplot(precio_por_subcategoria1, aes(x = Sub_categoria, y = Precio_Unitario_Promedio, color = Pais)) +
...
#Subimos el nivel de agregación, para usar conjunto de productos.
...
# Filtramos directamente, manteniendo solo las categorías que aparecen en 7 países.
